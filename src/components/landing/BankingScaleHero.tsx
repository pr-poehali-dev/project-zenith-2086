...
const stats: StatItem[] = [
  {
    value: "2 000+",
    description: "Участников прошли\nтренинг",
    delay: 0,
  },
  {
    value: "94%",
    description: "Отмечают снижение\nуровня стресса",
    delay: 0.2,
  },
  {
    value: "6 недель",
    description: "Программа с поддержкой\nкуратора",
    delay: 0.4,
  },
  {
    value: "4.9 / 5",
        ...
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            <h2 className="text-[40px] font-normal leading-tight tracking-tight text-[#111A4A] mb-6">
              Тысячи людей уже изменили качество своей жизни{" "}
              <span className="opacity-40">
                благодаря практикам эмоционального баланса и внутренней устойчивости.
              </span>
            </h2>

            <p className="text-lg leading-6 text-[#111A4A] opacity-60 mt-0 mb-6">
              Тренинг построен на доказательных методах психологии и помогает не просто «успокоиться», а выстроить устойчивую систему управления своим состоянием в любой ситуации.
            </p>
